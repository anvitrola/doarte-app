...
import { Article, Container } from "./QuestionsPage.styles";
    ...
    <Container>
      <Article>
        <div>
          ...
          <h3>Como eu começo uma vaquinha? </h3>
        </div>

        <p>
          {" "}
          Começar a sua vaquinha online é muito fácil. Você precisará dedicar
          apenas alguns minutos para estar habilitado a começar a receber
      ...
      <Article>
        <div>
          <h3>Como eu divulgo minha vaquinha?</h3>
        </div>
        <p>
          ...
          sua vaquinha no Stories, é interessante gravar vídeos curtos
          explicando mais sobre ela. Desta forma, há mais chances das pessoas se
          sensibilizarem com a sua causa. 🙂 Se você tiver Twitter, use e abuse
          dele! Já observamos campanhas com sucesso que divulgaram bastante
          através dele.
        </p>
      </Article>
      ...
      <Article>
        ...
        <p>
          ...
          atividade onde pessoas se juntam dando contribuições para atingir
          determinado objetivo financeiro) na internet. Foi criado em 2021 para
          permitir que qualquer pessoa tivesse a oportunidade de iniciar uma
          campanha de maneira fácil e rápida. Você mesmo pode iniciar a sua
          vaquinha online acessando o site Doarte e clicando em "Criar sua
          vaquinha". A maioria das campanhas possuem um objetivo bem claro: são
          causas sociais, casos de saúde, ajuda para custear algum sonho,
          arrecadações solidárias e até mesmo projetos para financiamento de
          estudo, viagem, produtos, livros, casamentos, formaturas e projetos
          pessoais. Seja qual for o objetivo, dependerá só de você conseguir
          mobilizar as pessoas. O dinheiro arrecadado fica atrelado a sua conta
          dentro do site do Vakinha. Você terá acesso a todas essas informações,
          incluindo quem doou, a data, o valor, a forma de pagamento, entre
          outros. Assim você consegue gerenciar a sua campanha e saber quem doou
          e até mesmo quem apenas gerou um boleto e deixou em aberto. Legal, né?
          Abrir uma campanha não tem custo algum. A cobrança da nossa taxa é
          feita sobre cada doação feita. A taxa é de 6,4% + R $0,50 por
          transação. Se você pesquisar, verá que somos o melhor custo-benefício
          para as vaquinhas online! No momento do saque é aplicado uma taxa de R
          $5,00. Essa taxa é cobrada a cada saque realizado, por isso
          recomendamos você efetuar o mínimo de saques possíveis para reduzir o
          seu custo. E o melhor: estamos disponíveis para tirar suas dúvidas e
          ajudá-lo no que for necessário. Nossa equipe é especialista no
          assunto!
        </p>
      </Article>
      <Article>
